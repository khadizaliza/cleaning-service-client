...
const Navbar = ({children}) => {
  ...
  <div class="drawer-content flex flex-col">
    ...
    <div class="w-full navbar bg-base-100 lg:px-20 fixed top-0 z-10">
    <div class="flex-1 px-2 mx-2 text-2xl">Cleaning Service</div>
      ...
      <div class="flex-none hidden lg:block">
        <ul class="menu menu-horizontal gap-2">
          ...
          <li><NavLink to="/contect" className='rounded-lg'>Contect</NavLink></li>
  ...
  <li><NavLink to="/home" className='rounded-lg'>Home</NavLink></li>
          ...
          <li><NavLink to="/service" className='rounded-lg'>Service</NavLink></li>
          <li class="dropdown dropdown-hover dropdown-end"></li>
